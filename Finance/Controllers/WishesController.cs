...
namespace Finance.Controllers
{
    public class WishesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Status,CreationDate")] Wish wish)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Status,CreationDate")] Wish wish)
        {
            if (id != wish.Id)
            {
                return NotFound();
