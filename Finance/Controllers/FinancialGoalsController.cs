...
namespace Finance.Controllers
{
    public class FinancialGoalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Amount,Name,CreatedOn,EstimatedCompletion,Status")] FinancialGoal financialGoal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Amount,Name,CreatedOn,EstimatedCompletion,Status")] FinancialGoal financialGoal)
        {
